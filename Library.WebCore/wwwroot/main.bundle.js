...
let BookDataService = class BookDataService {
    ...
    getBooks() {
        return this.http.get(this.url).map((books) => { return books; });
    }
    getBook(id) {
